...
export class WalletView extends LitElement {
  ...
  render() {
    ...
    height: 72px;
      ...
      <custom-icon-set name="wallet-icons">
        <template>
          <span name="send">@symbol-input_circle</span>
          <span name="receive">@symbol-output_circle</span>
      ...
      <flex-column class="main" @click=${this.#handleClick}>
        ...
        <flex-row class="wallet-nav">
          <a title="send">
            <custom-icon set="wallet-icons" icon="send"></custom-icon>
          </a>
          <a title="recceive">
            <custom-icon set="wallet-icons" icon="receive"></custom-icon>
          </a>
          <a title="transactions">
            <custom-icon set="wallet-icons" icon="list"></custom-icon>
          </a>
        </flex-row>
      </flex-column>
    `
